...
**Rules Engine Integration**: If you want to use the Rules Engine page (`/rules_engine`), you'll need to set:
- `RULES_ENGINE_URL` - The URL of the ChatRPG backend (default: `http://localhost:8080`)
- `RULES_ENGINE_TIMEOUT` - Request timeout in milliseconds (default: `30000`)

Make sure the backend is running and accessible at the configured URL.
